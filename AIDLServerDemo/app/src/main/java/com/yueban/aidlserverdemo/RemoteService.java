package com.yueban.aidlserverdemo;
...
public class RemoteService extends Service {
    ...
    private final IRemoteService mRemoteService = new IRemoteService() {
        ...
        public void basicTypes(int anInt, long aLong, boolean aBoolean, float aFloat, double aDouble, String aString) {
            final String msg =
                "Execute basicTypes() in server: " + anInt + ", " + aLong + ", " + aBoolean + ", " + aFloat + ", " + aDouble +
                ", " + aString;
            mHandler.post(() -> Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show());
        }
